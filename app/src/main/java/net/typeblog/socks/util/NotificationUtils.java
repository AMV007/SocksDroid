...
public class NotificationUtils {
    ...
    private static final String notificationName = "VpnService";
    ...
    /**
     * startForegroundService witth Notification
     */
    ...
    private static Notification getNotification(Service service) {
        ...
        PendingIntent pi = PendingIntent.getActivity(service, 0, i, Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ? PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_UPDATE_CURRENT);
